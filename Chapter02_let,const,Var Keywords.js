console.log("In this we are going to learn the keyword use for declaring the variables:- let,const,var")
...
var c="singh";
{
  ...
  var c=5; //variable declared with the var keyword can be accessed outside the block
  console.log(c);
}
console.log(a);
...
const b="Kumar";
console.log(b);
//so variable declared or initialized with const keyword can't be changed. hence lines 23 and 24 will throw an error
//const b=98;
//b=9;